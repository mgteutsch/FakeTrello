...
namespace FakeTrello.Tests.DAL
{
    ...
    public class FakeTrelloRepoTests
    {
        ...
        public void CreateFakeDatabase()
        {
            ...
            //fake_context.Setup(c => c.SaveChanges()).Verifiable().Returns(0);
            fake_context.Setup(c => c.SaveChanges()).Returns(0).Verifiable();
            /* See 'EnsureICanEditBoardName' test */
        }
        ...
        public void EnsureICanEditBoardName()
        {
            ...
            //verify that SaveChanges is called in that manner, and called one times (Times.Once) 
        }
    }
}
